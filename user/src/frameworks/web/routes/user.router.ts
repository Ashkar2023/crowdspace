import { IAuthContoller, IUserController } from "@adapters/controllers/interfaces/controller.interface.js";
import { createCallback } from "@crowdspace/common";
import { Router, RequestHandler } from "express";

export function buildUserRoutes({ router, userController }: { // parameter is an object and names should match
    router: Router,
